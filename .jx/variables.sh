...
export JENKINS_X_URL='https://dashboard.dev.pauwelslabs.com/pauwels-labs/redact-data/main/1'
export JX_CHART_REPOSITORY='http://jenkins-x-chartmuseum.jx.svc.cluster.local:8080'
export MINK_AS='tekton-bot'
export MINK_IMAGE='274295908850.dkr.ecr.eu-west-1.amazonaws.com/pauwels-labs/redact-data:0.2.0'
